...
int main()
{
	...
	while(1)
	{
		...
		printf("\n 1 for  creating the linked list \n 2 for view \n 3 for showing the maximum element of the linked list \n 4 for showing the minimum element of a linked lising t");
...
void create()
{
 ...
 // function for printing the maximum value node of linked list
 void max()
 {
 	int max=head->data;
 	struct node *ptr;
  ...
  // function for printing the minimum value node of linked list
 void min()
 {
 	int min=head->data;
 	struct node *ptr;
